...
To accomodate a group of up to 10 chargers (depending on the amperage of the EVSEs planned), we
would need:
...
<img src="{{ site.cdn }}2019ev/openhouse.jpg" class="img-responsive" title="" />
...
and would cover the cost of the installation and EVSE.
...
## 2014-2015: Surveys and proposals, no action
...
PPTX - EV Open House
DOCX sample policy
Seattle City Light code
Seattle City Light EV multi-family
Puget Sound Energy EV multi-family, shared spaces
Tesla letter to condo board
ChargePoint page
Clipper Creek page

# What other Seattle condos have done
...
- EV charging parking spaces are being sold similar to a backsplash or appliance upgrade at time of sale.

## New construction tower (2019)

- A new community amenity will be a fleet of shared EV cars available for rent to owners

## Hotel condo tower

Valet-assisted charging available

## Unfortunate Tower 1

Not allowing any charging at this time

## Unfortunate Tower 2

Not allowing any charging at this time

## Unfortunate Belltown Tower 3

Not allowing any charging at this time

## Unfortunate Belltown Tower 4
...
# Model 3 Performance notes

It gets better over time

V10 was a great release

AutoPilot is getting better

I use AutoStreet

Redmond commute to Seattle
